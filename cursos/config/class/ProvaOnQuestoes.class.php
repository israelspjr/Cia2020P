<?php
class ProvaOnQuestoes extends Database {
	// class attributes
	var $id;
	var $provasOnIdProvaOn;
	...
	function setId($value) {
		$this -> id = ($value) ? $this -> gravarBD($value) : "NULL";
	}

	function setProvasOnIdProvaOn($value) {
		$this -> provasOnIdProvaOn = ($value) ? $this -> gravarBD($value) : "NULL";
	}
...
//		echo $sql;
	 ...
	 */
	function deleteProvaOnQuestoes() {
		$sql = "DELETE FROM provaOnQuestoes WHERE id = $this->id";
		$result = $this -> query($sql, true);
	}
	 ...
	 */
	function updateFieldProvaOnQuestoes($field, $value) {
		$value = ($value != "NULL") ? $this -> gravarBD($value) : $value;
		$sql = "UPDATE provaOnQuestoes SET " . $field . " = " . $value . " WHERE id = $this->id";
	//	echo $sql;
		$result = $this -> query($sql, true);
	}
	 ...
	 */
	function updateProvaOnQuestoes() {
		$sql = "UPDATE provaOnQuestoes SET provaOn_idProvaOn = $this->provaOnIdProvaOn, ordem = $this->ordem, inativo = $this->inativo, questao_idQuestao = $this->questaoIdQuestao WHERE id = $this->id";
	//	echo $sql;
		$result = $this -> query($sql, true);
	}
	 ...
	 */
	function selectProvaOnQuestoes($where = "WHERE 1") {
		$sql = "SELECT SQL_CACHE id, provaOn_idProvaOn, ordem, inativo, questao_idQuestao FROM provaOnQuestoes " . $where;
...
//			echo "<br>".$sql;
	 ...
	 */
	function selectProvaOnQuestoesTr($caminhoAbrir, $caminhoAtualizar, $ondeAtualiza, $where = "", $idPai = "", $caminhoModulo = "") {
