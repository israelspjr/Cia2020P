...
echo $retorno['nps'];
	?></div>
        ...
        </div><hr><div>* Este gráfico leva em consideração a data inicial de 01/09/2019 para pesquisar outro período utilize o relatório de pesquisa de satisfação. </div>
