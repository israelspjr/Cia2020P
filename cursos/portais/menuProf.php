...
<ul class="nav menu">
        ...
        <li <?php echo $disabled?>><a href="#" onclick="zerarCentro();fecharMenu(0);carregarModulo('/cursos/portais/modulos/novaPsa/index.php', '#centro');"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Pesquisa de satisfação</a></li>
