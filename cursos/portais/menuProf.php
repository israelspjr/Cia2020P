...
<ul class="nav menu">
			...
			<li <?php echo $disabled?> ><a href="#"  onclick="zerarCentro();carregarModulo('/cursos/mobile/professor/modulos/ff/index.php', '#centro')"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Folha de frequência</a></li>
		<li <?php echo $disabled?>><a href="#" onclick="zerarCentro();carregarModulo('/cursos/mobile/professor/modulos/psa/index.php', '#centro');"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Pesquisa de satisfação antiga</a></li>
        <li <?php echo $disabled?>><a href="#" onclick="zerarCentro();carregarModulo('/cursos/mobile/professor/modulos/novaPsa/index.php', '#centro');"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Pesquisa de satisfação nova</a></li>
		...
		<!--	<li>
            ...
            <li><a href="#" onclick="zerarCentro();carregarModulo('/cursos/mobile/professor/modulos/busca/index.php', '#centro');"><svg class="glyph stroked round-coffee-mug"><use xlink:href="#stroked-round-coffee-mug"></use></svg> <blink>Vagas</blink></a></li>
