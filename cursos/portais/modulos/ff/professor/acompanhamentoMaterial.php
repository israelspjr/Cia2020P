...
<!--<div class="conteudo_nivel">
  ...
  <fieldset>
    ...
    <form id="form_AcompanhamentoMaterial" class="validate" method="post" action="" onsubmit="return false" >
      ...
      <p>
        <?php if($idKit!=""):?>  
        <label>Material: <b></strong><?php echo $material->selectKitMaterialDescricao($where,false);?></b></label>
      ...
      <p>   
        ...
        <button class="Bblue" onclick="enviadoOK();postForm('form_AcompanhamentoMaterial', 'modulos/ff/professor/acompanhamentoMaterialAcao.php');zerarPlano()">Salvar</button>&nbsp;&nbsp;
        
         <button class="button gray" onclick="zerarPlano();">Fechar</button>
