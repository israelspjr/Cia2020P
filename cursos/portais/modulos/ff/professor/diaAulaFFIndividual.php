...
<form id="form_uploadFile" method="post" enctype="multipart/form-data" action="modulos/ff/professor/diaAulaFFIndividualAcao.php" style="display:none">
...
<?php  foreach($rsIntegranteGrupo as $valorIntegranteGrupo){ ?>
  <table id="tb_lista_FolhaFrequencia_form_individual_<?php echo $valorIntegranteGrupo['idIntegranteGrupo'];?>" class="registros">
    ...
    <thead>
      <tr>
        ...
        <th>Período</th>
        <th>Horas dadas</th>
        <th>Aluno: <?php echo $IntegranteGrupo->getNomePF($valorIntegranteGrupo['idIntegranteGrupo'], true);?></th>
        </tr>
      </thead>
        ...
        if($idAulaDataFixa){
          ...
          <tr align="center" class="<?php echo $reposicao ? "reposicao" : ""?>"> 
                 ...
                 //       echo Uteis::exibirHoras($horasTotal);                   
                        ...
                        onclick="preencheAlunos('<?php echo "horaRealizadaAluno_".$idDiaAulaFF."_base"?>', '<?php echo $idDiaAulaFF?>', '<?php echo $idIntegranteGrupo?>')" <?php echo $finalizar ? "style=\"display:none;\"" : ""?> />
        	    ...
        	    <?php } ?>       
                                ...
                                if( $dataEntrada_aluno <= $dataAula && (!$dataSaida_aluno || ( $dataSaida_aluno && $dataSaida_aluno >= $dataAula)) ){ ?>
                                    ...
                                    <form id="<?php echo "form_".$nomeCampo?>" class="validate ff_individual" method="post" action="" onsubmit="return false"  >
                                            ...
                                            <p>
                                                <input type="text" name="<?php echo "horaRealizadaAluno_".$nomeCampo?>" class="hora required <?php echo "dia_".$idDiaAulaFF."_id_".$idIntegranteGrupo?>" size="5"
...
<?php foreach($rsIntegranteGrupo as $valorIntegranteGrupo){ ?>
<script>
//tabelaDataTable('tb_lista_FolhaFrequencia_form_individual_<?php echo $valorIntegranteGrupo['idIntegranteGrupo']?>');
</script>
<?php }?>
<script>
...
function preencheAlunos(id, classe,idAluno){
	var horas = $('#'+id).val();
