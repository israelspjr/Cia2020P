...
<p>".$observacao."</p>";
    ...
    $msg .= "<p><a href=https://".$_SERVER['SERVER_NAME']."/cursos/portais/login.php?idPlanoAcaoGrupo=".$idPlanoAcaoGrupo."&mes=".$mes."&ano=".$ano."&".$tipo."=".$ValorTipo."&password=".EncryptSenha::B64_Decode($senhaAcesso)."&tipo=1&idIntegranteGrupo=".$idIntegranteGrupo."&idFolhaFrequencia=".$idFolhaFrequencia.">      Sim</a></p>	
          <p><a href=https://".$_SERVER['SERVER_NAME']."/cursos/mobile/aluno/login.php?idPlanoAcaoGrupo=".$idPlanoAcaoGrupo."&mes=".$mes."&ano=".$ano."&".$tipo."=".$ValorTipo."&password=".EncryptSenha::B64_Decode($senhaAcesso)."&tipo=2&idIntegranteGrupo=".$idIntegranteGrupo."&idFolhaFrequencia=".$idFolhaFrequencia."&idProfessor=".$idProfessor."&mes=".$mes."&ano=".$ano.">    Não </a></p>";

			$msg .= "Para acessar o portal do aluno <a href=https://".$_SERVER['SERVER_NAME']."/cursos/portais/login.php?mes=".$mes."&ano=".$ano."&".$tipo."=".$ValorTipo."&password=".EncryptSenha::B64_Decode($senhaAcesso).">clique aqui</a><p> A equipe da ".$config[0]['nomeEmpresa'].".</p>Atenciosamente,</p>";
