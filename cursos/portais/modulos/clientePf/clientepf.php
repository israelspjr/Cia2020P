...
require_once "../resourceHTML/endereco.php"; 
echo "<p>";
require_once "../resourceHTML/enderecoVirtual.php"; 
echo "</p>";
echo "<p>";
require_once "../resourceHTML/telefone.php"; 
echo "</p>";
echo "<p>";
require_once "../resourceHTML/formacaoPerfil.php"; 
echo "</p>";
...
function enviar() {
	...
	postForm('form_clientepf', '<?php echo "modulos/cadastro/acao/clientepf.php?id=".$idClientePf?>');
	enviadoOK();
	zerarCentro();
	carregarModulo('modulos/cadastro/resourceHTML/opcaoAtividadeExtraClientePf.php', '#centro');
