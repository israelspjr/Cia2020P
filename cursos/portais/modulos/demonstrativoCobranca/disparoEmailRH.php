    ...
    <form id="form_disparoEmailRH" class="validate" action="" method="post" onsubmit="return false" >
      ...
      <div class="esquerda">
        ...
        <p>        
         ...
         <div class="esquerda">
          <label><strong>Contato(s) Empresa: (Necessário escolher um)</strong></label>
      ...
      <div class="linha-inteira">
      <p>      
          <button class="bBlue" onclick="dispara()">Enviar</button>
...
function dispara(){
	...
	postForm('form_disparoEmailRH', '<?php echo "modulos/demonstrativoCobranca/disparoEmailRHAcao.php?idClientePj=".$idClientePj?>');
