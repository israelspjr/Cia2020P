...
//GERA A PARTIR DO Q FOI GRAVADO
	...
	$where2 = " WHERE demonstrativoCobranca_idDemonstrativoCobranca = $idDemonstrativoCobranca and clientePf_idClientepf = ".$idClientePf;
	...
	//INTEGRANTES
	$cont = 0;
	$rsDemonstrativoCobrancaIntegranteGrupo = $DemonstrativoCobrancaIntegranteGrupo->selectDemonstrativoCobrancaIntegranteGrupoInd($where2);
          ...
          <!--demonstrativo_geral-->
           <tr>
               <td align="center">
                   ...
                   <tr>  
                        <td>
                        <strong>Valor(es) de crédito</strong>:
                        </td>                         
                        <td colspan = "3">                             
                              <?php if($rsCredito){
                 ...
                 <tr>
                     <td>
                         <strong>Valor(es) de débito</strong>:
                     </td>
                     <td  colspan = "3">  
                          <?php if($rsDebito){
                 ...
                 <tr>
                     <td colspan = "4">
                         <strong>Adicionais ao valor do curso</strong>: 
                        ...
                        <strong>Sub total</strong>:
                         ...
                         <td colspan = "3">
                            <div class="tab1">
                              ...
                              <?php }?>
                              <?php if($totalCredito){?>
                              <strong>Créditos</strong>: R$ <?php echo Uteis::formatarMoeda($totalCredito)?><br />
                              <?php }?>
                              <?php if($totalDebito){?>
                              <strong>Débitos</strong>: R$ <?php echo Uteis::formatarMoeda($totalDebito)?><br />
                              <?php }?>              
                            </div>
                     </td>
                </tr>     
    ...
    <tr>
        <th colspan="3">
            ...
            <?php 
                  $totalCurso_sub = $totalAlunos_curso[$cont]['total'];                         
                  $totalMaterial_sub = $totalAlunos_material[$cont]['total'];
                  $total_sub = $totalCurso_sub + $totalMaterial_sub + $totalCreditoA - $totalDebitoA; //$TCA - $TDA ;
                    echo "<strong>R$ ".Uteis::formatarMoeda($total_sub)."</strong>";
                  $cont++;
              ?>
        </th>
