     ...
     <!--   <label>Selecionados:</label>-->
        ...
        <div class="linha-inteira">
          <p>
            ...
            de
            <input type="text" name="dataReferencia" id="dataReferencia" class="data" value="2020-01-01"/> <!--01/09/2018" />-->
            a
            <input type="text" name="dataReferencia2" id="dataReferencia2" class="data" value="<?php echo $dataAtual;?>"  />
          </p>
          <p>
