...
<fieldset>
  ...
  <div class="lista">
    <table id="tb_lista_MaterialDidaticPlanoAcao" class="registros">
      <thead>
        <tr>
          <th>Nome</th>
          <th>Editira</th>
      ...
      <tbody>
        <?php echo $MaterialDidaticPlanoAcao->selectMaterialDidaticPlanoAcaoTr(" WHERE planoAcao_idPlanoAcao = ".$idPlanoAcao);?>
      </tbody>
      <tfoot>
        <tr>
          <th>Nome</th>
...
<script> tabelaDataTable('tb_lista_MaterialDidaticPlanoAcao', 'simples');</script> 
