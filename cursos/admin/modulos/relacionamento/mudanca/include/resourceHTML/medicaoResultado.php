...
<fieldset>
  ...
  <div class="lista">
    <table id="tb_lista_PlanoAcaoMedicaoResultado3" class="registros">
      <thead>
        <tr>
          <th>Medição</th>
          <th>Quantidade</th>
      ...
      <tbody>
        <?php echo $PlanoAcaoMedicaoResultado->selectPlanoAcaoMedicaoResultadoTr(" WHERE planoAcao_idPlanoAcao = ".$idPlanoAcao,1);?>
      </tbody>
      <tfoot>
        <tr>
          <th>Medição</th>
...
<script> tabelaDataTable('tb_lista_PlanoAcaoMedicaoResultado3', 'simples');</script> 
