...
<fieldset>
  ...
  <div class="lista">
    <table id="tb_lista_MaterialMontadoPlanoAcao3" class="registros">
      <thead>
        <tr>
          <th>Nome</th>
          <th>Preço</th>
      ...
      <tbody>
        <?php echo $MaterialMontadoPlanoAcao->selectMaterialMontadoPlanoAcaoTr(" WHERE planoAcao_idPlanoAcao = ".$idPlanoAcao,1);?>
      </tbody>
      <tfoot>
        <tr>
          <th>Nome</th>
...
<script> tabelaDataTable('tb_lista_MaterialMontadoPlanoAcao3', 'simples');</script> 
