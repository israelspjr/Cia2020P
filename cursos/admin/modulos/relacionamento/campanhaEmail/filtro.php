...
<fieldset>
 ...
 <div class="menu_interno"> <img src="<?php echo CAMINHO_IMG."novo.png"?>" title="Nova mensagem" 
  onclick="abrirNivelPagina(this, '<?php echo CAMINHO_REL."campanhaEmail/formulario.php".$param?>', '<?php echo CAMINHO_REL."campanhaEmail/filtro.php"?>', '#centro')" /> </div>
...
-          	<option value="" selected="selected" >Todos</option>
   ...
   <!--       <p>
     ...
     <!--     <p>
          <input name="grupo1[]" type="checkbox" id="grupo1" checked="checked"   />Mostrar grupos
        </p>-->
      </div>
...
<fieldset>
  <legend>Campanhas de Email Marketing</legend>
