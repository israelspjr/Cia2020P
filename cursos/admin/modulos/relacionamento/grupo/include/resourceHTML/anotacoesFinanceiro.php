...
<fieldset>
  ...
  <div class="menu_interno"><img src="<?php echo CAMINHO_IMG."novo.png";?>" title="cadastrar anotação" onclick="abrirNivelPagina(this, '<?php echo CAMINHO_REL."grupo/include/form/anotacoesFinanceiro.php";?>?idPlanoAcaoGrupo=<?php echo $idPlanoAcaoGrupo?>', '<?php echo CAMINHO_REL."grupo/include/resourceHTML/anotacoesFinanceiro.php?id=".$idPlanoAcaoGrupo?>', '#div_anotacoes_financeiro');" /></div>
  <div id="div_lista_anotacoes_financeiras" class="lista">
    <table id="tb_lista_anotacoes_financeiras" class="registros">
      ...
      <tbody>
        <?php 
	echo $RegistroDeAnotacoes->selectRegistroDeAnotacoesTr(CAMINHO_REL."grupo/include/form/anotacoesFinanceiro.php", CAMINHO_REL."grupo/include/resourceHTML/anotacoesFinanceiro.php?id=".$idPlanoAcaoGrupo, "#div_anotacoes_financeiro", $where, "&idPlanoAcaoGrupo=".$idPlanoAcaoGrupo);
	?>
      </tbody>
      <tfoot>
        <tr>
