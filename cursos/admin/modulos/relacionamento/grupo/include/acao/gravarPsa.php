...
$dissertativa =  $_REQUEST['dissertativa'];
if( $idRespostaPsaProfessor ){
		
	//$obsMsg = "<br /><small>".$PsaProfessor->getNome($_REQUEST['psaProfessor_idPsaProfessor'])."</small>";
