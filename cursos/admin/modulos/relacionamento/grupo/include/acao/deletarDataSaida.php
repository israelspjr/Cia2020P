...
if ($idIntegranteGrupo != '') {
  ...
  $IntegranteGrupo->updateFieldIntegranteGrupo("dataSaidaDemonstrativo", '');
  $IntegranteGrupo->updateFieldIntegranteGrupo("dataSaida", '');
  $IntegranteGrupo->updateFieldIntegranteGrupo("obs", '');
