...
if($_POST['acao']=="deletar"){
	...
	if($justificaFalta){
		...
		$arrayRetorno['elementoAtualizar'][0] = "#".$nomeCampo.'_'.$idDiaAulaFFIndividual;
		
		$valajax = $justificaFalta."&nbsp;&nbsp;		
		&nbsp;&nbsp;<img src=\"".CAMINHO_IMG."excluir.png\" title=\"Excluir justificativa:\n".$justificaFalta."\" 
		onclick=\"excluiJustificativa('".$idDiaAulaFFIndividual."', '".$nomeCampo."')\" />
		<img src=\"".CAMINHO_IMG."editar.png\" title=\"Editar justificativa:\n".$justificaFalta."\" 
		onclick=\"editarJustificativa('".$idDiaAulaFFIndividual."', '".$nomeCampo."', '".$justificaFalta."')\" />";
...
}elseif($_POST['acao']=="EditarJustificativa"){
	...
	if($justificaFalta){
		...
		$arrayRetorno['mensagem'] = "Justificativa atualizada com sucesso.";
	}else{
		$arrayRetorno['mensagem'] = "Digite uma justificativa";
	}
