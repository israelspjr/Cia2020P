  ...
  <fieldset>
    ...
    <form id="form_desvincular" class="validate" method="post" action="" onsubmit="return false">
      ...
      <p>
        ...
        onclick="postForm('form_desvincular', '<?php echo CAMINHO_REL."grupo/include/acao/planoAcaoGrupoKitMaterial.php?id=".$id?>')">Salvar</button>
      </p>
    </form>
  </fieldset>
</div>
