...
<div class="conteudo_nivel">
  ...
  <fieldset>
    <legend>Desvincular material avulso</legend>
    <form id="form_desvincular" class="validate" method="post" action="" onsubmit="return false">
      ...
      <p>
        ...
        onclick="postForm('form_desvincular', '<?php echo CAMINHO_REL."grupo/include/acao/planoAcaoGrupoMaterialDidatico.php?id=".$id?>')">Salvar</button>
      </p>
    </form>
  </fieldset>
</div>
