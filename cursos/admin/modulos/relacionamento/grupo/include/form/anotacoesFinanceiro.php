...
<div class="conteudo_nivel">
  ...
  <fieldset>
    ...
    <form id="form_RegistroDeAnotacoes" class="validate" action="" method="post" onsubmit="return false" >
      ...
      <p>
      <?php if ($idClientePj != '') { ?>
       <button class="button blue" onclick="postForm('form_RegistroDeAnotacoes', '<?php echo CAMINHO_REL?>grupo/include/acao/anotacoesFinanceiro.php?id=<?php echo $idRegistroDeAnotacoes?>&idClientePj=<?php echo $idClientePj?>');">Salvar</button> 
        <?php } else { ?>
