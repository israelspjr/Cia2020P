...
$DemonstrativoCobranca = new DemonstrativoCobrancaIntegranteGrupo();
$dc = $DemonstrativoCobranca->selectDemonstrativoCobrancaIntegranteGrupo("WHERE idDemonstrativoCobrancaIntegranteGrupo = ".$idDemonstrativoCobranca);
$obs = /*Uteis::exibirData(*/$dc[0]['obs'];//);
?>
<div class="conteudo_nivel">
  <div id="fechar_nivel" class="fechar" onclick="fecharNivel();" title="Fechar"></div>
  <fieldset>
    <legend>Inserir NFe / Aluno</legend>
    <form id="form_alterarVencimento" class="validate"  method="post" onsubmit="return false" >
      ...
      <p>        
      <button class="button blue" onclick="postForm('form_alterarVencimento', '<?php echo CAMINHO_RELAT?>consolidado/include/acao/alterarNFaluno.php?tr=1')">Salvar</button>
      </p>
    </form>
  </fieldset>
</div>
