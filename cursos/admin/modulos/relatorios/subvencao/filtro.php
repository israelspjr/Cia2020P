...
$arrItens_padrao[] = array(0 => "dataInicio", 1 => "Data Inicio");
$arrItens_padrao[] = array(0 => "dataFim", 1 => "Data Fim");
$arrItens_padrao[] = array(0 => "subVencao", 1 => "Subvenção");
$arrItens_padrao[] = array(0 => "teto", 1 => "Teto");
$arrItens_padrao[] = array(0 => "quemP", 1 => "Quem Paga");
?>

<fieldset>
  <legend>Relatório de subvenção</legend>
...
function geraRel(){
    ...
    postForm_relatorio('img_form_Grupos', '', 'form_rel_pf', '<?php echo CAMINHO_RELAT."subvencao/index.php"?>', '#res_rel');
