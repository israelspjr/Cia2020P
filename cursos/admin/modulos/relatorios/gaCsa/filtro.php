...
<fieldset>
  <legend>Relatório de Ocorrências FF</legend>
      ...
      <div class="linha-inteira">
        <div class="esquerda">Período:
         ...
         <p>
            ...
            <?php echo $Professor->selectProfessorSelect("", "", " AND inativo = 0 AND candidato = 0")?></p>
             <p>
          <label>Gerente:</label>
        ...
        <?php echo $OcorrenciaFF->selectOcorrenciaFFSelectMulti()?>
        </p>
  <!--      </p> 
      ...
      <div class="linha-inteira" >
        <button class="button blue" id="geraRel" onclick="postForm_relatorio('img_form_Grupos', '', 'form_rel_pf', '<?php echo CAMINHO_RELAT."gaCsa/index.php"?>', '#res_rel')">Gerar relatório</button>
      </div>
    </form>
  </div>
</fieldset>
