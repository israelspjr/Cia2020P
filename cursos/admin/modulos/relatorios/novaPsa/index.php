     ...
     <!--   <label>Selecionados:</label>-->
        <img src="<?php echo CAMINHO_IMG."menos.png"?>" name="delIten" id="delIten" title="Remover iten" onclick="addIten('#sel_lista_padrao', '#sel_lista_opcional')"/>
         ...
         <p>
            ...
            de
            <input type="text" name="dataReferencia" id="dataReferencia" class="data hasDatepicker" value="" />
            a
            <input type="text" name="dataReferencia2" id="dataReferencia2" class="data hasDatepicker" value="" />
          </p>
        ...
        <p>
            ...
            <div id="grupo_idAlunos" name="grupo_idAlunos">
             ...
             <p>
            <label>Nota:</label>
            <?php echo $NotasTipoNota->selectNotasTipoNotaSelect("","", " AND tipoNota_idTipoNota = 4") ?>
            </p>
...
function geraRel(){
    ...
    postForm_relatorio('img_form_Grupos', '', 'form_rel_pf', '<?php echo CAMINHO_RELAT."novaPsa/include/resourceHTML/psa.php"?>', '#res_rel');
