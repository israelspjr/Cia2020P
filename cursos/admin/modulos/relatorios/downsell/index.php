...
$arrItens_padrao[] = array(0 => "dataInicio", 1 => "Data do Inicio");
$arrItens_padrao[] = array(0 => "dataTermino", 1 => "Data do Termino");
$arrItens_padrao[] = array(0 => "descricao", 1 => "Descrição");
$arrItens_padrao[] = array(0 => "cargaAntiga", 1 => "Carga Antiga");
$arrItens_padrao[] = array(0 => "cargaNova", 1 => "Carga Nova");
$arrItens_padrao[] = array(0 => "upselling", 1 => "Upselling");
$arrItens_padrao[] = array(0 => "status", 1 => "Status");
?>

<fieldset>
  <legend>Relatório de Downsell / Upselling</legend>
...
onclick="abrirFormulario('div_form_Grupos', 'img_form_Grupos');" />
  <div class="agrupa" id="div_form_Grupos">
   ...
   <!--                  <label>Selecionados:</label>
        ...
        <p>-->
          <select multiple="multiple" name="sel_lista_padrao[]" id="sel_lista_padrao" size="8"  style="display:none;">
        ...
        <p>
          ...
          <p>-->
            ...
            <select name="Tipo" id="Tipo"  >
              ...
              <option value="1" >Temporario</option>
            </select>
          </p>
                <p>
          <label>Empresa:</label>        
...
function geraRel(){
    ...
    postForm_relatorio('img_form_Grupos', '', 'form_rel_pf', '<?php echo CAMINHO_RELAT."downsell/include/resourceHTML/downsell.php"?>', '#res_rel');
