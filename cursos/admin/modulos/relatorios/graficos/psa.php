    ...
    <div class="agrupa" id="div_form_Grupos">
        <form id="form_rel_pf" class="validate" method="post" action="" onsubmit="return false" >
            ...
            <!--<div class="direita">
                ...
                <p>
                    <Label>Mostrar PSA não respondidas </Label>
                    <input type="checkbox" value="1" id="psaNao" name="psaNao" />
                </p>
            </div>-->
    </div>
...
*/
 ...
 /*   function alunosGrupo(){
    ...
    function geraRel(){
        if ($("#professor_idProfessor").val()==='-'){
            alert('- Selecione um campo professor!');
            return false;
        }
        ...
        postForm_relatorio('img_form_Grupos', '', 'form_rel_pf', '<?php echo CAMINHO_RELAT."graficos/psa/include/resourceHTML/psa.php"?>', '#res_rel');
    }
    ativarForm();
</script> 