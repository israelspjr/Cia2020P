...
if($_POST['tipo']=='frequencia'):
require_once "../frequencia/include/acao/filtros.php";
$param = "tipo:".$tipo.", mesIni:".$mes_ini.", mesFim:".$mes_fim.", anoIni:".$ano_ini.", anoFim:".$ano_fim.", idGrupo:".$idGrupo.", clientePj_idClientePj:".$clientePj_idClientePj.", where:".$where;

elseif($_POST['tipo']=='psa'):    
require_once "../psa/include/acao/filtros.php";
$param = "";

elseif($_POST['tipo']=='pagamento'):    
require_once "../pagamento/include/acao/filtros.php";
$param = "";

else:    
require_once "../recebiveis/include/acao/filtros.php";
$param = "";
