...
$arrItens_padrao[] = array(0 => "dataFechamento", 1 => "Data do Fechamento");
$arrItens_padrao[] = array(0 => "tipo", 1 => "Tipo");
$arrItens_padrao[] = array(0 => "observacoes", 1 => "Observações");
?>

<fieldset>
  <legend>Relatório de fechamento de grupo</legend>
  ...
  <div class="agrupa" id="div_form_Grupos">
    <form id="form_rel_pf" class="validate" method="post" action="" onsubmit="return false" >
      ...
      <div class="linha-inteira">
        ...
        <p>
          <select multiple="multiple" name="sel_lista_padrao[]" id="sel_lista_padrao" size="8" >
...
function geraRel(){
    ...
    postForm_relatorio('img_form_Grupos', '', 'form_rel_pf', '<?php echo CAMINHO_RELAT."fechamentoGrupo/include/resourceHTML/fechamentoGrupo.php"?>', '#res_rel');
