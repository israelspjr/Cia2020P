...
//	$gnome = $g->selectGrupo("WHERE idGrupo = ".$grupos[$i]);
    $demonstrativo .= file_get_contents("http://".CAMINHO_VER_DM."demonstratioEmail.php?p=".Uteis::base64_url_encode($idPlanoAcaoGrupo)."&m=".Uteis::base64_url_encode($mes)."&a=".Uteis::base64_url_encode($ano));
   $demonstrativo .= "<hr>";
