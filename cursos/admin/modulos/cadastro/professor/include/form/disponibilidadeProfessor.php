  ...
  <fieldset>
    ...
    <form id="form_DisponibilidadeProfessor" class="validate" method="post" action="" onsubmit="return false" >
      ...
      <div class="linha-inteira">
        <p>
          <button class="button blue" onclick="postForm('form_DisponibilidadeProfessor', '<?php echo CAMINHO_CAD?>professor/include/acao/disponibilidadeProfessor.php?id=<?php echo $idDisponibilidadeProfessor?>')">Salvar</button>
