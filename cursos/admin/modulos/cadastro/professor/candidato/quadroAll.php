...
?>
	  ...
	  <div class="esquerda">
	  <p><label>Nome:</label><?php echo $nome2?></p>
	  <p><label>Email:</label><?php echo $email?></p>
	  <p><label>WhatsApp:</label><?php echo $ddd."-".$tel;?></p>
	  ...
	  <div class="direita"><p><label>Nacionalidade:</label><?php echo $nacionalidade?></p>
	  <p><label>Mora:</label><?php echo $mora?></p>
