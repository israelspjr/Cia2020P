...
<?php         
	...
	if($_POST['acao'] == 'deletar'){
		...
		$IdiomaProfessor->setNivel($_POST['nivelF']);
		...
		if($idIdiomaProfessor != "" && $idIdiomaProfessor > 0 ){
			...
			$arrayRetorno['mensagem'] = "Cadastro efetuado com sucesso. Insira um plano de carreira para esse idioma.";
		}
		
		$arrayRetorno['atualizarNivelAtual'] = true;
		$arrayRetorno['pagina'] = CAMINHO_CAD."professor/contratado/include/form/idiomaProfessor.php?id=".$idIdiomaProfessor;
	}
