...
<div class="conteudo_nivel">
  ...
  <fieldset>
   ...
   <div class="linha-inteira">   
        <button class="button blue" onclick="postForm('form_indicacaoClientePf', '<?php echo CAMINHO_CAD."clientePj/include/acao/indicacaoClientePf.php?idClientePj=$idClientePj"?>')">Salvar</button>
    </div>    
      </p>
    </form>
  </fieldset>
